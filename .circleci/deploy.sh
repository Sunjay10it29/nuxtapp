...
ssh-keyscan -vvv -H -p 3456 49.0.71.34 >> ~/.ssh/known_hosts
cat ~/.ssh/id_ed25519 | ssh -vvv -p 3456 sunjay@49.0.71.34 'cat >> .ssh/authorized_keys'
ssh -vvv -p 3456 sunjay@49.0.71.34 "cd /home/sunjay/testproduction/nuxtapp/; pwd; yarn install; git pull origin master; exit" 